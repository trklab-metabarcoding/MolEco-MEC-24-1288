...
pacman::p_load(taxize, maps, ggplot2, countrycode, rgbif, data.table, raster, maps, mapproj)
```
...
combtab_subset_barcodes

combtab_split_barcodes <- strsplit(combtab$multi, "-")
combtab_split_barcodes
...
t.mean.files <- list.files("input_files/wc2.1_10m_tavg/", ".tif", full.names=TRUE)
p.mean.files <- list.files("input_files/wc2.1_10m_prec/", ".tif", full.names=TRUE)
