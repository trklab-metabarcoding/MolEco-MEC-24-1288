...
famnames <- taxize::downstream("Embryophyta", db = "itis", downto = "family") #Embryophyta is multicellular plants (excluding green algae)
...
### Next we can loop over these families and generate CSV files with all the species in these familis.
