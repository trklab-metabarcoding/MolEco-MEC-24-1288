...
pacman::p_load(dplyr, curl, zip, bold, readr, rgbif, usethis, stringr)
```
...
```{r retrieve_keys}
species_list <- readr::read_csv("./BOLD_spplist_20240109.csv") %>%
  pull("Species")
...
```{r check_dl}
occ_download_wait('0066932-241126133413365')
```
